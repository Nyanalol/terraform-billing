-- Campos derivados bajados desde Data Studio a la vista (menos calculados en el informe):
...
SELECT
  *,
  total_gcp_gmp + reseller_margin_gmp + reseller_margin_gcp + reseller_margin_thirdparty_marketplace AS total_net_cost,
